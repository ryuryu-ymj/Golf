...
class GdxArray2d<T>() {
    private val topRight = GdxArray<GdxArray<T>>()
    private val topLeft = GdxArray<GdxArray<T>>()
    private val bottomRight = GdxArray<GdxArray<T>>()
    private val bottomLeft = GdxArray<GdxArray<T>>()
